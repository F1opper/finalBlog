...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='blog',
            name='posted',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2023, 12, 16, 12, 16, 32, 506814), verbose_name='Опубликована'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(db_index=True, default=datetime.datetime(2023, 12, 16, 12, 16, 32, 507812), verbose_name='Дата комментария')),
