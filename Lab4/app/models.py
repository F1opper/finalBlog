...
class Blog(models.Model):
    ...
    # Методы класса
    def get_absolute_url (self): # Метод взозвращает строку в URL-адресом записи
        return reverse ("blogpost", args=[str(self.id)])
    def __str__(self): # Метод возвращает название, используемое для представления отдельных записей в администартивном разделе
        return self.title
